...
<body>
    ...
    <div class="col-md-10" style="width: 20cm; padding-left: 3cm;">
        <h2> Edit Data Barang Masuk </h2><br>
        <form action="{{ url('data_barangmasuk/'.$barangmasuk->id) }}" method="post" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="form-group">
                <label>Nama Barang</label>
                <input type="text" class="form-control" name="nama_barang" value="{{$barangmasuk->nama_barang}}" disabled>
                <input type="number" class="form-control" name="id_barang" value="{{$barangmasuk->id_barang}}" hidden>
            </div>
            <div class="form-group">
                <label>Jumlah Barang Masuk </label>
                <input type="number" class="form-control" name="jumlah_barangmasuk" value="{{$barangmasuk->jumlah}}" required>
            </div>
            <div class="form-group">
