...
<li><a href="{{ url('home') }}"><i class="fa fa-home fa-fw" ></i>&nbsp; Home</a></li>
   ...
   <h2> Edit Barang Masuk </h2><br>
   <form action="{{ url('data_barangmasuk/'.$data_barangmasuk->id) }}" method="post">
          @method('patch')
          @csrf
					<div class="form-group">
						<label>Nama Barang</label>
						<input type="text" class="form-control" name="nama_barang" value="{{ $data_barangmasuk->nama_barang }}" required>
					</div>
               <div class="form-group">
               ...
               <div class="form-group">
						...
						<input type="int" class="form-control" name="jumlah_barangmasuk" value="{{ $data_barangmasuk->jumlah_barangmasuk }}" required>
					</div>
                    <div class="form-group">
						<label>Waktu Barang Masuk</label>
						<input type="date" class="form-control" name="waktu_barangmasuk" value="{{ $data_barangmasuk->waktu_barangmasuk }}" required>
					</div>
               <br>
               ...
               <a href="{{ url('data_barangmasuk') }}" class="btn btn-danger" type="cancel" name="cancel">Cancel</a>
		</form>
   </div>
