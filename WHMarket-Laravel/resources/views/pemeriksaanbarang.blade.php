...
<li><a href="{{ url('home') }}"><i class="fa fa-home fa-fw" ></i>&nbsp; Home</a></li>
   ...
   <div class="col-md-10" style="margin-top: 0px;">
                    <h2> Pemeriksaan Barang </h2>
                    <br>
                    <a href="{{ url('tambah_pemeriksaanbarang') }}" class="btn btn-primary mt-3">Tambah Pemeriksaan Barang</a>
                    <br><br>
                    <table class="table table-bordered mt-3">
                       <thead class="thead-dark">
                          <tr>
                             ...
                             <th>Satuan</th>
                             <th>Kemasan</th>
                             <th>Jumlah Barang Aman</th>
                             <th>Jumlah Barang Expired</th>
                          ...
                          <tr>
                             ...
                             <form action="{{ url('pemeriksaanbarang/'.$item->id) }}" method="post" class="d-inline">
                              @method('delete')
                                @csrf
