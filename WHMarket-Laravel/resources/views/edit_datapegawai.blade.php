      ...
      <form action="{{ url('datapegawai/'.$datapegawai->id) }}" method="post">
          ...
          @csrf
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nama_pegawai" value="{{ $datapegawai->nama_pegawai }}">
					</div>
					<div class="form-group">
						<label>Alamat</label>
                    ...
                    <div class="form-group">
						<label>Kota</label>
						<input type="text" class="form-control" name="kota" value="{{ $datapegawai->kota }}">
					</div>
                    <div class="form-group">
						<label>Email</label>
               ...
               <a href="{{ url('datapegawai') }}" class="btn btn-danger" type="cancel" name="cancel">Cancel</a>
		</form>
   </div>
