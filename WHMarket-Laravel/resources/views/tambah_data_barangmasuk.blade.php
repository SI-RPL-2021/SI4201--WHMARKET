...
<body>
    ...
    <div class="col-md-10" style="width: 20cm; padding-left: 3cm;">
        <h2> Tambah Data Barang Masuk </h2><br>
        <form action="{{ url('data_barangmasuk') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="jumlah_barangmasuk" required>
            </div>
            <div class="form-group">
