...
<body>
    ...
    <div class="col-md-10" style="width: 20cm; padding-left: 3cm;">
        <h2> Tambah Data Pemeriksaan Barang </h2><br>
        <form action="{{ url('pemeriksaanbarang') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="jumlah_barangaman" required>
            </div>
            <br>
            <div class="form-group">
                <label>Jumlah Barang Expired </label>
                <input type="number" class="form-control" name="jumlah_barangexpired" required>
            </div>
            <br>
            <div class="form-group">
                <label>Waktu Pemeriksaan Barang </label>
                <input type="date" class="form-control" name="waktu_pemeriksaanbarang" required>
            </div>

            <button class="btn btn-primary" type="submit" name="submit">Submit</button>
            <a href="{{ url('pemeriksaanbarang') }}" class="btn btn-danger" type="cancel" name="cancel">Cancel</a>
        </form>
    </div>
