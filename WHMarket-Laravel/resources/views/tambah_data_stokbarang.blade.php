...
<body>
    ...
    <div class="col-md-10" style="width: 20cm; padding-left: 3cm;">
        <h2> Tambah Data Stok Barang </h2><br>
        <form action="{{ url('data_stokbarang') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label>Nama Barang</label>
                <select name="barang" id="nama_barang" class="form-control nama-barang">
            ...
            <a href="{{ url('data_stokbarang') }}" class="btn btn-danger" type="cancel" name="cancel">Cancel</a>
        </form>
    </div>
