...
<li><a href="{{ url('home') }}"><i class="fa fa-home fa-fw" ></i>&nbsp; Home</a></li>
   ...
   <h2>Tambah Data Supplier </h2><br>
            <form action="{{ url('datasupplier') }}" method="post" enctype="multipart/form-data">
               @csrf
            ...
            <div class="form-group">
               ...
               <a href="{{ url('datasupplier') }}" class="btn btn-danger" type="cancel" name="cancel">Cancel</a>
				</form>
   </div>
