...
<body>
    ...
    <div class="col-md-10" style="width: 20cm; padding-left: 3cm;">
        <h2> Tambah Data Barang Keluar </h2><br>
        <form action="{{ url('data_barangkeluar') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="jumlah_barangkeluar" required>
            </div>
            <div class="form-group">
                <label>Waktu Barang Keluar </label>
                <input type="date" class="form-control" name="waktu_barangkeluar" required>
            </div>
            <br>
