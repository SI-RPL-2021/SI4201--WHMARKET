...
<li><a href="{{ url('home') }}"><i class="fa fa-home fa-fw" ></i>&nbsp; Home</a></li>
   ...
   <h2> Edit Barang Keluar </h2><br>
   <form action="{{ url('data_barangkeluar/'.$data_barangkeluar->id) }}" method="post">
          @method('patch')
          @csrf
					<div class="form-group">
						<label>Nama Barang</label>
						<input type="text" class="form-control" name="nama_barang" value="{{ $data_barangkeluar->nama_barang }}" required>
					</div>
               <div class="form-group">
               ...
               <div class="form-group">
						...
						<input type="int" class="form-control" name="jumlah_barangkeluar" value="{{ $data_barangkeluar->jumlah_barangkeluar }}" required>
					</div>
                    <div class="form-group">
						<label>Waktu Barang Keluar</label>
						<input type="date" class="form-control" name="waktu_barangkeluar" value="{{ $data_barangkeluar->waktu_barangkeluar }}" required>
					</div>
               <br>
