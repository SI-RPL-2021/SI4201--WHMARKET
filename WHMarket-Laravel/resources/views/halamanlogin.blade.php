...
<div class="container-fluid px-1 px-md-4 px-lg-1 px-xl-4 py-4 mx-auto">
    <div class="card card0 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"> <img src="/assets/img/WHMARKET.png" width="50" height="40" class="logo"> </div>
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="/assets/img/login-image.png" width="600" height="380">
                     </div>
                </div>
            </div>
